...
# Print info about the database instances I am using
...
# Take the matricies generated by the tests and format them into a csv
...
# Select clauses for the two different clickhouse schema
...
# Return one of the clickhouse queries, slightly randomized
...
# Return one of the cassandra queries, slightly randomized
